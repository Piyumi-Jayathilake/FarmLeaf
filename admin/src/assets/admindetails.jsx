...
export const styles = {
    ...
    heartsWrapper: "flex items-center gap-2 text-red-500 font-[Playfair_Display]",
    ...
    formTitle: "text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-amber-400 to-orange-300 bg-clip-text text-transparent text-center font-[Playfair_Display] italic",
    ...
    navContainer: "max-w-7xl mx-auto px-2 sm:px-4 flex justify-between items-center min-h-20 py-3",
    logoSection: "flex items-center space-x-2 sm:space-x-3 flex-shrink-0",
    logoIcon: "text-2xl md:text-xl lg:text-4xl text-[#4cf452]",
    logoText: "text-lg sm:text-xl md:text-2xl lg:text-3xl bg-gradient-to-r from-[#4cf452] to-[#048b0b] bg-clip-text text-transparent font-monsieur tracking-wider drop-shadow-[0_2px_2px] drop-shadow-black font-[Playfair_Display] italic whitespace-nowrap",
    menuButton: "text-amber-200 text-2xl lg:hidden flex-shrink-0",
    desktopMenu: "hidden lg:flex items-center space-x-2 xl:space-x-4 font-[Playfair_Display] flex-shrink-0",
    navLinkBase: "flex items-center space-x-2 px-3 sm:px-4 py-2 rounded-xl border-2 text-xs sm:text-sm font-medium transition-all hover:bg-[#048b0b]/20 whitespace-nowrap",
...
export const tableClasses = {
    ...
    table: 'w-full',
    headerRow: 'bg-white/10',
    headerCell: 'p-4 text-left text-amber-100 ',
    row: 'border-b border-green-100 hover:bg-[#048b0b]/30 transition-colors group',
    cellBase: 'p-4',
};
...
export const layoutClasses = {
    ...
    heading: 'text-3xl font-bold mb-8 bg-gradient-to-r from-amber-400 to-orange-300 bg-clip-text text-transparent text-center',
};
